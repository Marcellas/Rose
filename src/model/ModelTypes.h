...
namespace rose::model
{
    ...
    struct ModelRequest
    {
        ...
        std::int32_t maxGeneratedTokens{ 1536 };
    };
    ...
    struct ModelContextUsage
    {
        std::int32_t promptTokens{ 0 };

        std::int32_t contextCapacity{ 0 };

        std::int32_t requestedGenerationTokens{ 0 };


        [[nodiscard]]
        std::int32_t totalRequestedTokens() const noexcept
        {
            return
                promptTokens
